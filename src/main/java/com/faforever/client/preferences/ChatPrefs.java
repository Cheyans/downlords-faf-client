...
public class ChatPrefs {
  ...
  public ChatPrefs() {
    ...
    autoJoinChannels = new SimpleListProperty<>(FXCollections.observableArrayList(new ArrayList<String>()));
  }
  ...
  public void addAutoJoinChannel(String channelName) {
    autoJoinChannels.get().add(channelName);
  }

  public void removeAutoJoinChannel(String channelName) {
    autoJoinChannels.get().remove(channelName);
  }
}
