...
public class UserFilterController implements Controller<Node> {
  ...
  public BooleanProperty isFilterAppliedProperty() {
  ...
  public void onGameStatusPlaying(ActionEvent actionEvent) {
    if (playerStatusFilter == PLAYING) {
      updateGameStatusMenuText(null);
    } else {
      updateGameStatusMenuText(PLAYING);
    }
    filterUsers();
  }
  ...
  public void onGameStatusLobby(ActionEvent actionEvent) {
    if (playerStatusFilter == LOBBYING) {
      ...
      updateGameStatusMenuText(LOBBYING);
    }
    filterUsers();
  }

  public void onGameStatusNone(ActionEvent actionEvent) {
    if (playerStatusFilter == IDLE) {
      updateGameStatusMenuText(null);
    } else {
      updateGameStatusMenuText(IDLE);
    }
    filterUsers();
  }
